...
@section('content')
    ...
    <div class="document-form">
        ...
        <form action="{{ isset($document) ? route('backend.documents.update', $document->id) : route('backend.documents.store') }}"
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('backend.documents.index') }}" class="btn btn-secondary me-2">Cancel</a>
