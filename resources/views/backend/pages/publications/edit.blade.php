...
@section('content')
    <div class="card">
        <div class="card-body">
            <form
                action="{{ isset($publications) ? route('backend.publications.update', $publications->id) : route('backend.publications.store') }}"
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="date" class="form-control" id="date"
                        value="{{ old('date', isset($publications) ? \Carbon\Carbon::parse($publications->date)->format('Y-m-d') : '') }}"
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        @if (isset($publications) && $publications->image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $publications->image) }}" alt="publications Image"
                                    width="150">
                            </div>
                        @endif
                    </div>
                    ...
                    <a href="{{ route('backend.publications.index') }}" class="btn btn-secondary">Cancel</a>
            </form>
        </div>
    </div>
@endsection
