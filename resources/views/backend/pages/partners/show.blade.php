...
<div class="card">
    <div class="card-header d-flex">
        <a href="{{ route('backend.partners.index') }}" class="btn btn-secondary ms-auto">Back to List</a>
    </div>
    ...
    <div class="card-body show">
        ...
        <div class="mt-3">
            <a href="{{ route('backend.partners.edit', $partners->id) }}" class="btn btn-primary">Edit</a>
        </div>
    </div>
</div>
@endsection
